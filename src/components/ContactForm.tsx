...
export default function ContactForm() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="bg-gradient-to-br from-white/90 to-[color:var(--surface-elevated)]/80 backdrop-blur-sm border border-[color:var(--neutral-200)] rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 lg:p-10">
