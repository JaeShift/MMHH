...
export default function FAQ() {
    const faqs = [
      { q: "Do you accept insurance?", a: `Yes! I am in-network with many major plans and networks, including ${acceptedInsuranceNamesSentence()}. I also provide superbills for out-of-network reimbursement when applicable and accept HSA/FSA payments.` },
