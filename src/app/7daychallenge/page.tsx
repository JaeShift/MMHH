...
export default function SevenDayChallengePage() {
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: '#FAF8F3' }}>
      {/* Hero Section */}
      <section className="pt-16 pb-16 sm:pt-24 sm:pb-24" style={{ paddingTop: '64px', paddingBottom: '64px' }}>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 sm:space-y-6">
                <p className="text-xs sm:text-sm md:text-base font-medium tracking-[0.2em] uppercase text-center lg:text-left" 
                   style={{ 
                     color: '#D88A8A',
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-normal leading-tight text-center lg:text-left" 
                    style={{ 
              ...
              {!isSuccess ? (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {isSubmitting ? "Signing Up..." : "Start Challenge"}
                    </button>
                    {error && (
            ...
            <motion.div
              ...
              className="bg-white rounded-[14px] sm:rounded-[18px] border overflow-hidden mt-8 lg:mt-0"
              style={{ 
                borderColor: '#E0D8D0',
      ...
      {/* Footer */}
      <footer className="py-12 border-t" style={{ borderColor: '#E0D8D0' }}>
        <div className="mx-auto text-center" style={{ maxWidth: '1120px', paddingLeft: '24px', paddingRight: '24px' }}>
          <p className="text-sm leading-relaxed" style={{ color: '#6B6258', fontFamily: 'Inter, ui-sans-serif, system-ui, sans-serif' }}>
            ...
            <a href="mailto:info@modernmhh.com" className="underline" style={{ color: '#6B6258' }}>info@modernmhh.com</a>.
          </p>
        </div>
      </footer>
    </main>
