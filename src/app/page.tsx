...
export default function Page() {
  return (
    <>
      ...
      {/* AREAS OF CARE - Full Section */}
      <FocusAreas />

      {/* ABOUT PREVIEW */}
      <section id="provider" className="py-20 bg-[color:var(--surface)]">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          >
            <div className="bg-[#EBE4D6]/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-[#E2D9CD] shadow-sm relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#B5BDAC]/10 rounded-bl-full"></div>
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#E2D9CD]/20 rounded-tr-full"></div>
      ...
      {/* SERVICES PREVIEW */}
      <section id="services" className="py-20 bg-[color:var(--surface-muted)]">
        <div className="container mx-auto px-6 lg:px-8">
          <motion.div
          ...
          >
            <div className="text-center mb-16">
              <span className="badge mb-4 bg-white/50">Comprehensive Care</span>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                return (
                  <motion.div
                    key={service.title}
                    className="group bg-[#FCF8F0] rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-[#E2D9CD]/50 flex flex-col items-start relative overflow-hidden"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.4, delay: index * 0.05 }}
                  >
                    <div className="absolute top-0 right-0 w-16 h-16 bg-[#B5BDAC]/10 rounded-bl-full transform translate-x-4 -translate-y-4 group-hover:scale-150 transition-transform duration-500"></div>
                    
                    <h3 className="text-xl font-bold text-[color:var(--text-primary)] mb-4 relative z-10">{service.title}</h3>
                    <div className="mt-auto pt-4 w-full relative z-10">
                      <a
                        href="/services"
                        className="inline-flex items-center text-[#6B5B4D] font-semibold hover:text-[#392E26] transition-colors text-sm"
                      >
                        Learn More
      ...
      {/* TELEHEALTH PREVIEW */}
      <section id="telehealth" className="py-20 bg-[color:var(--surface)] relative overflow-hidden">
        {/* Subtle background accent */}
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-30">
           <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-[#B5BDAC]/10 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="card p-8 hover:shadow-md transition-all bg-white border-[#E2D9CD]">
                ...
                <ul className="space-y-3 text-[color:var(--text-secondary)] mb-6">
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-[#B5BDAC] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
              ...
              <div className="card p-8 hover:shadow-md transition-all bg-white border-[#E2D9CD]">
                <h3 className="text-2xl font-bold text-[color:var(--text-primary)] mb-4 flex items-center gap-3">
                  <span className="w-10 h-10 rounded-full bg-[#E2D9CD]/30 flex items-center justify-center text-[#6B5B4D]">
                ...
                <ul className="space-y-3 text-[color:var(--text-secondary)] mb-6">
                  <li className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-[#B6A593] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
      ...
      <section id="testimonials" className="py-20 bg-[#B5BDAC]/10">
        <div className="container mx-auto px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <span className="badge mb-4 bg-white/50">Patient Stories</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[color:var(--text-primary)] mb-12">Patient Experience</h2>
            
            <div className="bg-white rounded-2xl p-10 md:p-12 shadow-md border border-[#B5BDAC]/20 relative">
      ...
      {/* FAQ PREVIEW */}
      <section id="faq" className="py-20 bg-[color:var(--surface)]">
        <div className="container mx-auto px-6 lg:px-8">
          <motion.div
            className="max-w-4xl mx-auto text-center"
            initial={{ opacity: 0, y: 20 }}
      ...
      {/* CONTACT */}
      <section id="contact" className="py-20 bg-[#F9F9F9] relative overflow-hidden">
        {/* Background decorative elements */}
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#E2D9CD]/20 rounded-full blur-3xl opacity-50"></div>
        </div>

        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <span className="badge mb-4 bg-white">Contact Me</span>
            ...
            <div className="bg-white p-8 md:p-10 rounded-xl shadow-lg border border-[#E2D9CD]">
              <ContactForm />
            </div>

            <div className="text-center mt-8 text-sm text-[color:var(--text-muted)]">
              Prefer email? <a className="text-[#6B5B4D] font-medium hover:underline" href="mailto:info@modernmhh.com">info@modernmhh.com</a>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* FOOTER */}
      <footer className="bg-[#C5B9AA] border-t border-[#B5A999] py-12">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-sm text-[color:var(--text-muted)] text-center md:text-left">
              <p className="font-semibold text-[#392E26] mb-2 text-base">Modern Mental Health &amp; Hormones</p>
              <p className="mb-1 text-[#4A3E35]">© {new Date().getFullYear()} All rights reserved.</p>
              <p className="text-[#4A3E35]">Serving Columbus, Cleveland, Cincinnati, Toledo, Akron, Dayton, and all of Ohio</p>
            </div>
            
            <div className="flex flex-wrap justify-center gap-6">
              <a href="/privacy" className="text-sm font-medium text-[#392E26] hover:text-white transition-colors">Privacy Policy</a>
              <a href="/terms" className="text-sm font-medium text-[#392E26] hover:text-white transition-colors">Terms of Use</a>
              <a href="/financial-disclosure" className="text-sm font-medium text-[#392E26] hover:text-white transition-colors">Financial Disclosure</a>
            </div>
          </div>
        </div>
      </footer>
